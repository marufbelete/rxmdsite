...
const {crerateShipping,deleteshipping,editshipping,
  getShipping,getShippingById}=require('../controllers/shippingController')
const {errorHandler}=require('../middleware/errohandling.middleware')
const {authenticateJWT}=require('../middleware/auth.middleware');
const {authAdmin}=require('../middleware/role.middleware')

router.post('/addshipping',authenticateJWT,shippingValidate(),crerateShipping,errorHandler);
