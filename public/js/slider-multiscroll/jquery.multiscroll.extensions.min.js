...
!(function (e, t, n, o, i) {
  e.fn.multiscroll = function (s) {
    ...
    function T() {
      ...
      if (n.length) {
        var o = $("responsiveExpand", "isResponsive")
          ? e(".ms-left").find(
              '[data-panel="ms-left"][data-anchor="' + n + '"]'
            )
          : e(".ms-left").find('[data-anchor="' + n + '"]');
        ("undefined" == typeof lastScrolledDestiny ||
          n !== lastScrolledDestiny) &&
          k(o);
      }
    }
    e(this).length &&
      ...
      s.css3 &&
        (s.css3 = (function () {
          ...
          for (var l in (n.body.insertBefore(o, null), s))
            o.style[l] !== i &&
      ...
      e(".ms-left .ms-section, .ms-right .ms-section").each(function () {
        ...
        if (
          ...
          void 0 !== s.sectionsColor[n] &&
            e(this).css("background-color", s.sectionsColor[n]),
          void 0 !== s.anchors[n] && e(this).attr("data-anchor", s.anchors[n]),
          s.verticalCentered &&
            (t = e(this))
              .addClass("ms-table")
              .wrapInner(
                '<div class="ms-tableCell" style="height: ' + Y(t) + 'px" />'
              ),
      ...
      e(".ms-left .ms-section, .ms-right .ms-section")
        .each(function () {
          ...
          e(this).css({ height: "100%" }),
            !t &&
              s.navigation &&
              p.find("li").eq(t).find("a").addClass("active");
        })
        .promise()
        .done(function () {
    ...
    function M() {
      n.addEventListener
        ? (n.removeEventListener("mousewheel", H, !1),
          n.removeEventListener("wheel", H, !1))
        : n.detachEvent("onmousewheel", H);
    }
    function B() {
      n.addEventListener
        ? (n.addEventListener("mousewheel", H, !1),
          n.addEventListener("wheel", H, !1))
        : n.attachEvent("onmousewheel", H);
    }
    function H(n) {
    ...
    function R(t) {
      ...
      if (s.scrollOverflow) {
        var o = l.scrollOverflow.iscrollHandler.scrollable(
            e.fn.multiscroll.scrollOverflow.g_overedPanel()
          ),
          i = "down" === t ? "bottom" : "top";
        if (o.length > 0) {
    ...
    function P(t) {
      return e(".ms-left .ms-section.active").index() > t.index()
        ? "up"
        : "down";
    }
    function z(e) {
    ...
    function X(n) {
      if (F(n)) {
        ...
        if (!w) {
          ...
          (N = i.y),
            i.x,
            o.abs(G - N) > (e(t).height() / 100) * s.touchSensitivity &&
              (G > N ? R("down") : N > G && R("up"));
        }
      }
    }
    ...
    function V() {
      (u || f) &&
        (n.removeEventListener(y.touchstart, U),
        n.removeEventListener(y.touchmove, X, { passive: !1 }),
        n.addEventListener(y.touchstart, U),
        n.addEventListener(y.touchmove, X, { passive: !1 }));
    }
    function q() {
      (u || f) &&
        (n.removeEventListener(y.touchstart, U),
    ...
    function te(e) {
      ...
      return (
        (!(d[0].indexOf(t, d[0].length - t.length) < 0 && r && a != d[0]) &&
          m) ||
        !r
      );
    }
    function ne(e) {
      if (J(e) && l[e]) {
        ...
        if (!te(e)) {
          var i = function () {
            "9999999" !==
              (n ? c.find("div").first() : c.find("div").last()).css(
                "z-index"
              ) && (n ? c.prepend(t) : c.append(t));
          };
          i(), setInterval(i, 2e3);
        }
      }
