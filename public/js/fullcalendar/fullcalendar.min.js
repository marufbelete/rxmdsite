...
var FullCalendar = (function (e) {
  ...
  function se(e) {
    e.classList.remove("fc-unselectable"),
      e.removeEventListener("selectstart", J);
  }
  function le(e) {
  ...
  function de(e, t, n) {
    var r, o;
    for (r = 0; r < n.length; r++) if ((o = pe(e, t, n[r]))) return o;
    return 0;
  }
  function pe(e, t, n) {
  ...
  function Te(e, t) {
    return Oe(e) === Oe(t) ? Math.round(Ce(e, t)) : null;
  }
  function ke(e) {
    return Ne([e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate()]);
  }
  function Me(e, t, n, r) {
    var o = Ne([t, 0, 1 + xe(t, n, r)]),
      i = ke(e),
      a = Math.round(Ce(o, i));
  ...
  function Be(e, t) {
    if (e === t) return !0;
    for (var n in e) if (Ue.call(e, n) && !(n in t)) return !1;
    for (var n in t) if (Ue.call(t, n) && e[n] !== t[n]) return !1;
    return !0;
  }
  function je(e, t) {
    var n = [];
  ...
  function Ge(e, t, n) {
    ...
    for (var r in t) if (!(r in e) || !qe(e[r], t[r], n[r])) return !1;
  ...
  function Ze(e, t, n) {
    ...
    a)) {
      ...
      if (u.recurringDef) {
        ...
        for (
          var d = 0, p = Xe(u, c, t, r, o.recurringTypes);
          d < p.length;
          d++
        ) {
          var f = p[d],
            h = Ae(l, { start: f, end: r.add(f, c) });
          s[h.instanceId] = h;
        }
      }
    }
  ...
  function st(e) {
    return (
      he(e.getUTCHours(), 2) +
      ":" +
      he(e.getUTCMinutes(), 2) +
      ":" +
      he(e.getUTCSeconds(), 2)
    );
  }
  function lt(e, t) {
    void 0 === t && (t = !1);
  ...
  var dt = {
    ...
    yt = (function () {
      function e(e) {
        ...
        for (var o in e)
          o in dt
            ? ((n[o] = e[o]), (r = Math.max(dt[o], r)))
            : ((t[o] = e[o]), o in pt && (r = Math.max(pt[o], r)));
        (this.standardDateProps = t),
          (this.extendedSettings = n),
          (this.severity = r),
          (this.buildFormattingFunc = ut(Et));
      }
      return (
  ...
  var bt = (function () {
      ...
      return (
        (e.prototype.format = function (e, t, n) {
          return t.cmdFormatter(this.cmdStr, Dt(e, null, t, n));
        }),
        (e.prototype.formatRange = function (e, t, n, r) {
          return n.cmdFormatter(this.cmdStr, Dt(e, t, n, r));
        }),
        e
      );
    })(),
    Ct = (function () {
      ...
      return (
        (e.prototype.format = function (e, t, n) {
          return this.func(Dt(e, null, t, n));
        }),
        (e.prototype.formatRange = function (e, t, n, r) {
          return this.func(Dt(e, t, n, r));
        }),
        e
      );
    })();
  ...
  var Rt = {
      ...
      dayHeaders: Boolean,
      dayHeaderFormat: wt,
      dayHeaderClassNames: Ht,
      dayHeaderContent: Ht,
      dayHeaderDidMount: Ht,
      dayHeaderWillUnmount: Ht,
      dayCellClassNames: Ht,
      dayCellContent: Ht,
      dayCellDidMount: Ht,
      dayCellWillUnmount: Ht,
      initialView: String,
      aspectRatio: Number,
      weekends: Boolean,
      weekNumberCalculation: Ht,
      weekNumbers: Boolean,
      weekNumberClassNames: Ht,
      weekNumberContent: Ht,
      weekNumberDidMount: Ht,
      weekNumberWillUnmount: Ht,
      editable: Boolean,
      viewClassNames: Ht,
      viewDidMount: Ht,
      viewWillUnmount: Ht,
      nowIndicator: Boolean,
      nowIndicatorClassNames: Ht,
      nowIndicatorContent: Ht,
      nowIndicatorDidMount: Ht,
      nowIndicatorWillUnmount: Ht,
      ...
      initialDate: Ht,
      now: Ht,
      eventDataTransform: Ht,
      stickyHeaderDates: Ht,
      stickyFooterScrollbar: Ht,
      viewHeight: Ht,
      defaultAllDay: Boolean,
      eventSourceFailure: Ht,
      eventSourceSuccess: Ht,
      eventDisplay: String,
      ...
      slotLabelFormat: Ht,
      slotLaneClassNames: Ht,
      slotLaneContent: Ht,
      slotLaneDidMount: Ht,
      slotLaneWillUnmount: Ht,
      slotLabelClassNames: Ht,
      slotLabelContent: Ht,
      slotLabelDidMount: Ht,
      slotLabelWillUnmount: Ht,
      dayMaxEvents: Ht,
      dayMaxEventRows: Ht,
      dayMinWidth: Number,
      slotLabelInterval: $e,
  ...
  function Ot(e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = $t(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  var qt = {
    ...
    Yt = { id: String, groupId: String, title: String, url: String },
    Zt = { start: Ht, end: Ht, date: Ht, allDay: Boolean },
    Xt = r(r(r({}, Yt), Zt), { extendedProps: Ht });
  function Kt(e, t, n, r, o) {
    ...
    var c,
      d = (function (e, t, n, r) {
        ...
        a && s && (s = ke(s));
        i && ((u = i.marker), a && (u = ke(u)), s && u <= s && (u = null));
        u
          ? (l = !0)
          : r ||
    ...
    return d
      ? {
          def: (c = Qt(a, s, t ? t.sourceId : "", d.allDay, d.hasEnd, n)),
          instance: Ae(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo),
        }
      : null;
  }
  function Jt(e, t, n) {
    return void 0 === n && (n = $t(t)), Nt(e, n);
  }
  function $t(e) {
    return r(r(r({}, Ft), Xt), e.pluginHooks.eventRefiners);
  }
  ...
  function tn(e, t) {
    ...
    return (
      e.start && ((n = ke(e.start)), r && r <= n && (r = Se(n, 1))),
      { start: n, end: r }
    );
  }
  function nn(e) {
  ...
  function rn(e, t, n, r) {
    return "year" === r
      ? $e(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? $e(n.diffWholeMonths(e, t), "month")
      : we(e, t);
  }
  function on(e, t) {
    var n,
      ...
      o = [],
      i = t.start;
    for (e.sort(an), n = 0; n < e.length; n++)
  ...
  function pn(e, t, n, r) {
    ...
    for (var m in o)
      for (var y = 0, E = on(o[m], n); y < E.length; y++) {
        var S,
          D = E[y];
        f = u[(S = a[m]).defId];
        s.push({
    ...
    for (var c in i)
      for (var b = 0, C = on(i[c], n); b < C.length; b++) {
        D = C[b];
        s.push({
          def: e.defs[c],
          ui: u[c],
  ...
  var kn = { start: Ht, end: Ht, allDay: Boolean };
  function Mn(e, t, n) {
    var o = (function (e, t) {
        var n = Nt(e, kn),
          o = n.refined,
  ...
  function _n(e, t, n) {
    return r(r({}, In(e, t, n)), { timeZone: t.timeZone });
  }
  function In(e, t, n) {
    return {
  ...
  function Hn(e, t) {
    ...
    return (
      r(
        ...
        ((n = e),
        (o = t.dateEnv),
        r(r({}, In(n.range, o, n.allDay)), { allDay: n.allDay }))
      ),
      i
    );
  }
  function On(e, t, n) {
    ...
    return (
      e
        ? ((i = ke(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
  ...
  function An(e, t, n, r) {
    ...
    for (var l in e.instances) {
      var u = e.instances[l];
      s = i.defs[u.defId];
      i.instances[l] = Ln(u, s, o[u.defId], n, r);
    }
    return i;
  }
  function Un(e, t, n, o) {
  ...
  function Ln(e, t, n, o, i) {
    ...
    return (
      ...
      l &&
        (u.range = {
          start: u.range.start,
          end: On(t.allDay, u.range.start, i),
        }),
      t.allDay &&
        (u.range = { start: ke(u.range.start), end: ke(u.range.end) }),
      u.range.end < u.range.start &&
        (u.range.end = On(t.allDay, u.range.start, i)),
      u
    );
  }
  var Wn = (function () {
  ...
  function Fn(e) {
    return r(r(r({}, Ft), Vn), e.pluginHooks.eventSourceRefiners);
  }
  function Bn(e, t) {
    return (
      ...
      return (
        ...
        (e.prototype.today = function () {
          ...
          this.unselect(),
            this.dispatch({
              type: "CHANGE_DATE",
              dateMarker: Bn(e.calendarOptions.now, e.dateEnv),
            });
        }),
        ...
        (e.prototype.formatRange = function (e, t, n) {
          ...
          return r.formatRange(r.createMarker(e), r.createMarker(t), wt(n), n);
        }),
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof Gn) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({
                  type: "ADD_EVENTS",
                  eventStore: At({ def: n, instance: r }),
                }),
          ...
          if (s) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: At(s) }),
        ...
        (e.prototype.getEventById = function (e) {
          ...
          for (var i in ((e = String(e)), r)) {
            var a = r[i];
            if (a.publicId === e) {
              if (a.recurringDef) return new Gn(t, a, null);
              for (var s in o) {
                var l = o[s];
                if (l.defId === a.defId) return new Gn(t, a, l);
              }
            }
          }
          return null;
      ...
      return (
        ...
        (e.prototype.setStart = function (e, t) {
          ...
          var n = this._context.dateEnv,
            r = n.createMarker(e);
          if (r && this._instance) {
            var o = rn(this._instance.range.start, r, n, t.granularity);
            t.maintainDuration
        ...
        (e.prototype.setEnd = function (e, t) {
          ...
          if ((null == e || (n = r.createMarker(e))) && this._instance)
            if (n) {
              var o = rn(this._instance.range.end, n, r, t.granularity);
        ...
        (e.prototype.setDates = function (e, t, n) {
          ...
          if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
            ...
            !0 === n.allDay && (u = en(u));
            var c = rn(u.start, l, a, n.granularity);
            if (r) {
              var d = rn(u.end, r, a, n.granularity);
              (i = d),
                (o = c).years === i.years &&
                o.months === i.months &&
                o.days === i.days &&
        ...
        (e.prototype.mutate = function (t) {
          ...
          if (n) {
            var r = this._def,
              o = this._context,
              i = Ut(o.getCurrentData().eventStore, n.instanceId);
            i = An(
              i,
              {
                "": {
  ...
  var Qn = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return Oe(e) === Oe(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.countDurationsBetween = function (e, t, n) {
          ...
          return n.years && null !== (r = this.diffWholeYears(e, t))
            ...
            : n.days && null !== (r = Te(e, t))
            ? r / nt(n)
            : (t.valueOf() - e.valueOf()) / rt(n);
        }),
        ...
        (e.prototype.timestampToMarker = function (e) {
          return "local" === this.timeZone
            ...
            ? Ne(this.namedTimeZoneImpl.timestampToArray(e))
            : new Date(e);
        }),
        (e.prototype.offsetForMarker = function (e) {
          return "local" === this.timeZone
            ? -Ie(Pe(e)).getTimezoneOffset()
            : "UTC" === this.timeZone
            ? 0
  ...
  function ir(e) {
    ...
    return new Qn(
      r(r({ timeZone: Tt.timeZone, calendarSystem: "gregory" }, e), {
        locale: t,
      })
    );
  }
      ...
      return (
        (e.prototype.splitProps = function (e) {
          ...
          for (var c in ((this.eventUiBuilders = Ve(n, function (e, n) {
            return t.eventUiBuilders[n] || ut(vr);
          })),
          n)) {
            var d = n[c],
              p = a[c] || fr,
  ...
  function yr(e, t) {
    return (
      void 0 === t && (t = "day"), JSON.stringify({ date: at(e), type: t })
    );
  }
  var Er,
    Sr = null;
  ...
  function jr(e, t, n, r, o, i, a, s, l, u, c, d, p) {
    return {
      ...
      createScrollResponder: function (e) {
        return new Fr(e, u, $e(n.scrollTime));
      },
  ...
  var Gr = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(je(e, this.props), je(t, this.state)),
          !Ge(this.props, e, this.propEquality) ||
            !Ge(this.state, t, this.stateEquality)
        );
      }),
      ...
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, o, i) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (a = Ze(a, r, i)), Wt($r(e, t.sourceId), a);
          }
          return e;
      ...
      !(
        ...
        !(function (e, t, n, o) {
          var i = t.getCurrentData(),
            ...
            l = s.defs,
            u = s.instances,
            c = gn(l, a.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          o && (c = Ve(c, o));
          var d =
              ((v = e.eventStore),
              ...
              {
                defs: v.defs,
                instances: We(v.instances, function (e) {
                  return !g[e.instanceId];
                }),
              }),
            p = d.defs,
            f = d.instances,
            h = gn(p, e.eventUiBases);
          var v, g;
          for (var m in u) {
            var y = u[m],
              E = y.range,
            ...
            for (var w in f) {
              ...
              if (un(E, R.range)) {
                ...
                if (C && !C(new Gn(t, p[R.defId], R), new Gn(t, D, y)))
                  return !1;
              }
            }
            for (var T = i.eventStore, k = 0, M = S.allows; k < M.length; k++) {
              var x = M[k],
                ...
                P = T.instances[m],
                N = void 0;
              if (((N = I ? new Gn(t, I, P) : new Gn(t, D)), !x(Hn(_, t), N)))
                return !1;
            }
          }
          return !0;
          ...
          !(function (e, t, n, o) {
            ...
            for (var f in s) {
              ...
              if (un(u, h.range)) {
                ...
                if (p && !p(new Gn(t, a[h.defId], h), null)) return !1;
              }
            }
            for (var v = 0, g = c.allows; v < g.length; v++) {
              var m = g[v],
                y = r(r({}, n), l);
              if (!m(Hn(y, t), null)) return !1;
            }
            return !0;
          })(e, t, n, o)
        )
  ...
  var ao = (function (e) {
    ...
    return (
      ...
      (t.prototype.isInteractionValid = function (e) {
        ...
        if (t) for (var r in n) if (!cn(t.validRange, n[r].range)) return !1;
  ...
  var po = (function (e) {
    ...
    ho = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this;
          return Ar(fo.Consumer, null, function () {
        ...
        (t.prototype.renderInnerContent = function () {
          var e = this.context.pluginHooks.contentTypeHandlers,
            ...
            r = yo(t.content, t.hookProps),
            o = null;
          if (
            (void 0 === r && (r = yo(t.defaultContent, t.hookProps)),
            void 0 !== r)
          ) {
  ...
  function go() {
    ...
    return function (r, o) {
      return (
        (t && Be(t, o) && r === e) || ((e = r), (t = o), (n = mo(r, o))), n
      );
    };
  }
  function mo(e, t) {
    return "function" == typeof e && (e = e(t)), zt(e);
  }
  function yo(e, t) {
  ...
  function Do(e) {
    ...
    return (
      n.content &&
        ((t = n),
        (o = function (e) {
          return Ar(Br.Consumer, null, function (n) {
            return Ar(Eo, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
  ...
  var wo = (function () {
    function e(e) {
      (this.props = e),
        (this.nowDate = Bn(e.nowInput, e.dateEnv)),
        this.initHiddenDays();
    }
    return (
      ...
      (e.prototype.build = function (e, t, n) {
        ...
        return (
          ...
          d.showNonCurrentDates || (s = sn(s, o.range)),
          (s = sn((s = this.adjustActiveRange(s)), r)),
          (l = un(o.range, r)),
          {
            validRange: r,
      ...
      (e.prototype.buildCurrentRangeInfo = function (e, t) {
        ...
        return (
          r.duration
            ...
            : ((i = it((o = this.getFallbackDuration())).unit),
              (a = this.buildRangeFromDuration(e, t, o, i))),
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            (nt(o) < 0 && ((a = ke(a)), (a = n.add(a, o))),
            nt(i) > 1 && ((s = Se((s = ke(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          nt(n) <= 1 &&
            this.isHiddenDay(o) &&
            (o = ke((o = this.skipHiddenDays(o, t)))),
          d(),
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? $e(1, t) : e || $e({ days: 1 }))
        );
      }),
  ...
  function To(e, t, n, o) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return _o(e, t.sourceIds ? ze(t.sourceIds) : Po(e, o), s, o);
      case "RECEIVE_EVENTS":
        ...
        return (e ? e.split(" ") : []).map(function (e) {
          return e.split(",").map(function (e) {
            ...
            return (
              (t = l[e])
                ? ((d = function (e) {
                    t.click && t.click.call(e.target, e);
                  }),
  ...
  function Fo(e, t) {
    for (
      var n = Fe(t.getCurrentData().eventSources), r = [], o = 0, i = e;
      o < i.length;
      o++
    ) {
        ...
        eventSourceDefs: [
          {
            ...
            fetch: function (e, t, n) {
              ...
              Mr(
                e.eventSource.meta.bind(null, _n(e.range, r)),
                function (e) {
                  t({ rawEvents: e });
                },
                n
        ...
        recurringTypes: [
          {
            ...
            expand: function (e, t, n) {
              var r = sn(t, { start: e.startRecur, end: e.endRecur });
              return r
                ? (function (e, t, n, r) {
                    var o = e ? ze(e) : null,
                      i = ke(n.start),
      ...
      so({
        ...
        propSetHandlers: {
          dateProfile: function (e, t) {
            t.emitter.trigger(
              "datesSet",
              r(r({}, _n(e.activeRange, t.dateEnv)), { view: t.viewApi })
            );
          },
    ...
    Go = (function () {
      function e(e, t) {
        (this.runTaskOption = e),
          ...
          (this.queue = []),
          (this.delayedRunner = new jo(this.drain.bind(this)));
      }
      return (
        ...
        wt(
          t.titleFormat ||
            (function (e) {
              ...
              var n = Te(e.currentRange.start, e.currentRange.end);
              return null !== n && n > 1
  ...
  var Yo = (function () {
    function e(e) {
      var t = this;
      (this.computeOptionsData = ut(this._computeOptionsData)),
        (this.computeCurrentViewData = ut(this._computeCurrentViewData)),
        (this.organizeRawLocales = ut(nr)),
        (this.buildLocale = ut(rr)),
        (this.buildPluginHooks = lo()),
        (this.buildDateEnv = ut(Zo)),
        (this.buildTheme = ut(Xo)),
        (this.parseToolbars = ut(Lo)),
        (this.buildViewSpecs = ut(bo)),
        (this.buildDateProfileGenerator = ct(Ko)),
        (this.buildViewApi = ut(Jo)),
        (this.buildViewUiProps = ct(ei)),
        (this.buildEventUiBySource = ut($o, Be)),
        (this.buildEventUiBases = ut(Qo)),
        (this.parseContextBusinessHours = ct(ti)),
        (this.buildTitle = ut(qo)),
        (this.emitter = new xr()),
        (this.actionRunner = new Go(
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Bn(s.now, l)),
        d = a.dateProfileGenerator.build(c);
      dn(d.activeRange, c) || (c = d.currentRange.start);
      for (
        var p = {
            dateEnv: o.dateEnv,
      ...
      for (
        var v = Ro(o.calendarOptions, d, p),
          g = {
    ...
    return (
        ...
        this.data &&
          ...
          (d = (function (e, t, n, r) {
            ...
            switch (t.type) {
              ...
              case "CHANGE_DATE":
                if (!e.activeRange || !dn(e.currentRange, t.dateMarker))
          ...
          dn(d.currentRange, c) || (c = d.currentRange.start);
        for (
          var p = To(n.eventSources, e, d, u),
            f = ko(p),
            h = Kr(n.eventStore, e, p, d, u),
            v =
              (f &&
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = Pt([Tt, e, t]),
          ...
          c = (this.currentCalendarOptionsRefiners = r(
            r(r(r(r({}, Rt), kt), Mt), u.listenerRefiners),
            u.optionRefiners
          )),
          d = {},
          p = Pt([Tt, l, e, t]),
        ...
        for (var m in p)
          "plugins" !== m &&
            (p[m] === h[m] || (xt[m] && m in h && xt[m](h[m], p[m]))
              ? (f[m] = v[m])
              : c[m]
              ? ((f[m] = c[m](p[m])), (g = !0))
              : (d[m] = h[m]));
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        var a = Pt([Tt, e.optionDefaults, n, o, e.optionOverrides, i]),
          s = r(
            r(r(r(r(r({}, Rt), kt), Mt), It), t.listenerRefiners),
            t.optionRefiners
          ),
          l = {},
  ...
  function Zo(e, t, n, r, o, i, a, s) {
    var l = rr(t || a.defaultCode, a.map);
    return new Qn({
  ...
  function ti(e) {
    return sr(e.options.businessHours, e);
  }
  function ni(e, t) {
    for (var n in e)
      console.warn(
  ...
  var li = {},
    ...
    ci = {},
    di = { startTime: $e, duration: $e, create: Boolean, sourceId: String };
  function pi(e) {
    var t = Nt(e, di),
      n = t.refined,
      r = t.extra;
  ...
  var fi,
        ...
        return (
          (n.handleSegClick = function (e, t) {
            ...
            if (i && r.isValidSegDownEl(e.target)) {
              var a = G(e.target, ".fc-event-forced-url"),
          ...
          (n.destroy = Q(t.el, "click", ".fc-event", n.handleSegClick)),
          n
        );
      }
      return n(t, e), t;
    ...
    Ei = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildViewContext = ut(jr)),
          (t.buildViewPropTransformers = ut(Di)),
          (t.buildToolbarProps = ut(Si)),
          (t.handleNavLinkClick = $(
            "a[data-navlink]",
          ...
          (t.registerInteractiveComponent = function (e, n) {
            ...
            (t.interactionsStore[e.uid] = o), (li[e.uid] = r);
          }),
          (t.unregisterInteractiveComponent = function (e) {
            for (var n = 0, r = t.interactionsStore[e.uid]; n < r.length; n++) {
              r[n].destroy();
            }
            delete t.interactionsStore[e.uid], delete li[e.uid];
          }),
          (t.resizeRunner = new jo(function () {
  ...
  var Ci = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return bi() || i.push("fc-liquid-hack"), e.children(i, o, r, n);
      }),
      (t.prototype.componentDidMount = function () {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            u = [Ri].concat(mr(l, o), e.extraClassNames || []),
  ...
  var xi = (function (e) {
    function t(t, n) {
      ...
      return (
        (r.initialNowDate = Bn(n.options.now, n.dateEnv)),
  ...
  var Ii = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.createDayHeaderFormatter = ut(Pi)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
        ...
        return Ar(xi, { unit: "day" }, function (e, t) {
          return Ar(
            "tr",
            null,
            i && i(),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: De(e, 1) }, allDay: !1 }, {}, t], n)
          );
        }),
        ...
        (e.prototype._sliceInteraction = function (e, t, n, r) {
          for (var o = [], i = 4; i < arguments.length; i++)
            o[i - 4] = arguments[i];
          if (!e) return null;
          var a = pn(e.mutatedEvents, t, Ai(n, Boolean(r)), r);
          return {
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          ...
          this.forceDayIfListItem &&
            ...
            (n = { start: n.start, end: Se(n.start, 1) });
          for (
  ...
  function Ai(e, t) {
    ...
    return t
      ? n
      : {
          start: De(n.start, e.slotMinTime.milliseconds),
          end: De(n.end, e.slotMaxTime.milliseconds - 864e5),
        };
  }
  ...
  function Vi(e) {
    for (
      var t = 0, n = 0, r = Y(e, ".fc-scrollgrid-shrink");
      n < r.length;
      n++
    ) {
      var o = r[n];
  ...
  function Fi(e, t) {
    return null != t.maxHeight || zi(e, t);
  }
  function Bi(e, t, n) {
    var r = n.expandRows;
  ...
  function Xi(e, t) {
    var n = ["fc-scrollgrid-section", e.className];
    return (
      t &&
        e.liquid &&
        null == e.maxHeight &&
  ...
  var Qi = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.processCols = ut(function (e) {
          return e;
        }, ji)),
        (t.renderMicroColGroup = ut(Gi)),
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Ar(
          ...
          Boolean(d.length) && Ar.apply(void 0, o(["thead", {}], d)),
          Boolean(p.length) && Ar.apply(void 0, o(["tbody", {}], p)),
          Boolean(f.length) && Ar.apply(void 0, o(["tfoot", {}], f))
        );
      }),
      (t.prototype.renderSection = function (e, t, n) {
        return "outerContent" in e
          ...
          : Ar(
              "tr",
              { key: e.key, className: Xi(e, this.props.liquid).join(" ") },
      ...
      (t.prototype._handleScrollerEl = function (e, t) {
        var n = parseInt(t, 10);
        Xr(this.props.sections[n].chunk.scrollerElRef, e);
      }),
      (t.prototype.componentDidMount = function () {
  ...
  Qi.addStateEquality({ scrollerClientWidths: Be, scrollerClientHeights: Be });
  var ea = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = Lr()), t;
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            a = {
              ...
              isDraggable: !e.disableDragging && Sn(r, t),
              isStartResizable: !e.disableResizing && Dn(r, t),
              isEndResizable: !e.disableResizing && bn(r),
              isMirror: Boolean(
  ...
  var ra = function (e) {
      return Ar(Br.Consumer, null, function (t) {
        var n = t.options,
          r = {
            isAxis: e.isAxis,
    ...
    ia = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.refineHookProps = ct(sa)), (t.normalizeClassNames = go()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
          var e = this.props,
            ...
            i = r.isDisabled ? {} : { "data-date": at(e.date) };
          return Ar(
            vo,
            {
              hookProps: r,
  ...
  var fa = (function (e) {
    function t(t, n) {
      ...
      return (
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    Ar(
                      ...
                      Ar(Ei, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
        ...
        (o.el = t),
        (o.renderRunner = new jo(o.handleRenderRequest)),
        new Yo({
          optionOverrides: n,
          calendarApi: o,
    ...
    ma = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          va++ || window.addEventListener("touchmove", ya, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            --va ||
              window.removeEventListener("touchmove", ya, { passive: !1 });
        }),
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target;
          return (
            !(!t || (this.handleSelector && !G(n, this.handleSelector))) &&
            ((this.subjectEl = t),
            (this.downEl = n),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
        ...
        (e.prototype.querySubjectEl = function (e) {
          return this.selector ? G(e.target, this.selector) : this.containerEl;
        }),
      ...
      return (
        ...
        (e.prototype.doRevertAnimation = function (e, t) {
          ...
          (n.style.transition = "top " + t + "ms,left " + t + "ms"),
            X(n, { left: r.left, top: r.top }),
            te(n, function () {
              (n.style.transition = ""), e();
            });
        }),
        (e.prototype.cleanup = function () {
          this.mirrorEl && (V(this.mirrorEl), (this.mirrorEl = null)),
            (this.sourceEl = null);
        }),
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(Ca()));
          }
        }),
        ...
        for (var i in n) {
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              v &&
                cn(g.activeRange, v.dateSpan.range) &&
                (!o || v.layer > o.layer) &&
                ((v.rect.left += l),
                (v.rect.right += l),
                (v.rect.top += u),
  ...
  function Ma(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && xn(e.dateSpan, t.dateSpan))
    );
  }
  function xa(e, t) {
    for (
  ...
  var _a = (function (e) {
      function t(t) {
        ...
        var o = (n.hitDragging = new ka(n.dragging, si(t)));
        return (
      ...
      function t(t) {
        ...
        (n.dragSelection = null),
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (Nn(n.dragSelection, e, n.component.context),
              (n.dragSelection = null));
          });
        ...
        var a = (n.hitDragging = new ka(n.dragging, si(t)));
        return (
    ...
    function t(n) {
      ...
      (o.subjectEl = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          var u = (o.subjectSeg = vn(e.subjectEl)),
            c = (o.eventRange = u.eventRange).instance.instanceId;
          (o.relevantEvents = Ut(l.getCurrentData().eventStore, c)),
          ...
          var d = r.isValidSegDownEl(t) && !G(t, ".fc-event-resizer");
          i.setIgnoreMove(!d),
            (o.isDragging =
            ...
            if (e) {
              ...
              i === a || (p.editable && p.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = An(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
      ...
      var s = (o.hitDragging = new ka(o.dragging, li));
      return (
      ...
      (n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, o) {
          ...
          e &&
            (u = (function (e, t, n, o, i) {
              for (
                var a = e.component.context.dateEnv,
                  ...
                  u = rn(s, l, a, e.component.largeUnit),
                  c = {},
                  d = 0,
                  p = i;
                d < p.length;
            ...
            u &&
              ((c = An(a, i.getCurrentData().eventUiBases, u, i)),
              (p.mutatedEvents = c),
          ...
          (this.onDocumentPointerUp = function (e) {
            ...
            if (!r.wasTouchScroll) {
              if (o.dateSelection && !t.isRecentPointerDateSelect) {
                ...
                !i || (i && G(r.downEl, a)) || n.calendarApi.unselect(e);
              }
              o.eventSelection &&
                !G(r.downEl, Pa.SELECTOR) &&
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  var f = t.duration
                      ...
                      : On(e.allDay, p, n),
                    h = Ae(d.defId, { start: p, end: f });
                  return { def: d, instance: h };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = At(s)),
                (l = !Qr(u, a)) &&
          ...
          (this.handleDragEnd = function (e) {
            ...
            if ((n.clearDrag(), o && i)) {
              ...
              o.emitter.trigger(
                ...
                l.create &&
                  (o.dispatch({ type: "MERGE_EVENTS", eventStore: At(i) }),
                  e.isTouch &&
                    o.dispatch({
                      type: "SELECT_EVENT",
                  ...
                  o.emitter.trigger("eventReceive", {
                    draggedEl: e.subjectEl,
                    event: new Gn(o, i.def, i.instance),
                    view: s,
                  }));
            }
            (n.receivingContext = null), (n.droppableEvent = null);
          });
        var o = (this.hitDragging = new ka(e, li));
        (o.requireInitial = !1),
      ...
      return (
        (e.prototype.buildDragMeta = function (e) {
          return "object" == typeof this.suppliedDragMeta
            ? pi(this.suppliedDragMeta)
            : "function" == typeof this.suppliedDragMeta
            ? pi(this.suppliedDragMeta(e))
            : pi(
                (t = (function (e, t) {
        ...
        (e.prototype.canDropElOnCalendar = function (e, t) {
          ...
          return "function" == typeof n
            ...
            : "string" != typeof n || !n || Boolean(q(e, n));
        }),
        e
      );
    })();
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : Tt.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : Tt.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            Ar(Eo, { viewSpec: r.viewSpec }, function (e, t) {
              return Ar(
                "div",
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          return (
            ...
            Ar(Eo, { viewSpec: a.viewSpec }, function (e, t) {
              return Ar(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                Ar(o, {
            ...
            function (e, n) {
              return (
                ...
                Ar(
                  ...
                  Ar("a", r({ className: "fc-daygrid-day-number" }, t), n)
                )
              );
            }
          );
  ...
  function Ja(e) {
    ...
    return (
      "list-item" === t ||
      ("auto" === t && !e.eventRange.def.allDay && e.firstCol === e.lastCol)
    );
  }
  var $a = (function (e) {
    function t() {
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context,
          n = t.options.eventTimeFormat || Ka,
          o = Cn(e.seg, n, t, !0, e.defaultDisplayEventEnd);
        return Ar(
          ea,
          {
            seg: e.seg,
  ...
  function ts(e, t, n, o, i, a, s, l) {
    for (
      ...
      u.push([]), c.push(0);
    for (var m = 0, y = (t = yn(t, l)); m < y.length; m++) {
      T(
        (w = y[m]),
    ...
    !0 === n || !0 === o
      ? (function (e, t, n, r) {
          rs(e, t, n, !0, function (e) {
            return e.bottom <= r;
          });
        })(c, d, u, a)
      : "number" == typeof n
      ? (function (e, t, n, r) {
          rs(e, t, n, !1, function (e, t) {
            return t < r;
          });
        })(c, d, u, n)
      : "number" == typeof o &&
        (function (e, t, n, r) {
          rs(e, t, n, !0, function (e, t) {
            return t < r;
          });
        })(c, d, u, o);
    for (var E = 0; E < s; E++) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          r = this.context,
          o = t.cells.length,
          i = Ba(t.businessHourSegs, o),
          a = Ba(t.bgEventSegs, o),
          s = Ba(this.getHighlightSegs(), o),
          l = Ba(this.getMirrorSegs(), o),
          u = ts(
            t.cells,
            t.fgEventSegs,
            t.dayMaxEvents,
          ...
          for (var l = 0, u = e; l < u.length; l++) {
            ...
            s.push(
              Ar(
                ...
                "bg-event" === t ? Ar(ua, r({ seg: c }, wn(c, i))) : la(t)
              )
            );
          }
      ...
      (t.prototype.computeSegHeights = function () {
        return Ve(this.segHarnessRefs.currentMap, function (e) {
  ...
  os.addStateEquality({ segHeights: Be });
  var is = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.repositioner = new jo(t.updateSize.bind(t))),
          (t.handleRootEl = function (e) {
            (t.rootEl = e), t.props.elRef && Xr(t.props.elRef, e);
          }),
        ...
        (t.prototype.updateSize = function () {
          ...
          if (r) {
            ...
            (s = Math.min(s, window.innerHeight - i.height - 10)),
              ...
              X(r, { top: s, left: (o = Math.max(o, 10)) });
          }
        }),
        t
      );
      ...
      return (
        ...
        (t.prototype.queryHit = function (e, t, n, r) {
          ...
          if (e < n && t < r)
            return {
              component: this,
              dateSpan: { allDay: !0, range: { start: o, end: Se(o, 1) } },
    ...
    ss = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.splitBusinessHourSegs = ut(Fa)),
          (t.splitBgEventSegs = ut(Fa)),
          (t.splitFgEventSegs = ut(Fa)),
          (t.splitDateSelectionSegs = ut(Fa)),
          (t.splitEventDrag = ut(ja)),
          (t.splitEventResize = ut(ja)),
          (t.buildBuildMoreLinkText = ut(ls)),
          (t.rowRefs = new Wi()),
  ...
  var hs = so({
      ...
      optionRefiners: {
        moreLinkClick: Ht,
        moreLinkClassNames: Ht,
        moreLinkContent: Ht,
        moreLinkDidMount: Ht,
        moreLinkWillUnmount: Ht,
      },
      views: {
        dayGrid: {
          component: ps,
      ...
      return (
        (e.prototype.safeComputeTop = function (e) {
          ...
          if (dn(t.currentRange, e)) {
            ...
            if (r >= rt(t.slotMinTime) && r < rt(t.slotMaxTime))
              return this.computeTimeTop($e(r));
          }
        }),
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = ke(e)), this.computeTimeTop($e(e.valueOf() - t.valueOf()))
          );
        }),
    ...
    ys = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.rootElRef = Lr()), (t.slatElRefs = new Wi()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
        ...
        var r = n.dateEnv,
          ...
          a =
            null == o.slotLabelFormat
              ...
              ? wt(o.slotLabelFormat[0])
              : wt(o.slotLabelFormat),
          s = {
            time: e.time,
    ...
    for (
      var i = new Date(0),
        ...
        l =
          ...
          (function (e) {
            var t, n, r;
            for (t = ms.length - 1; t >= 0; t--)
              if (((n = $e(ms[t])), null !== (r = ot(n, e)) && r > 1)) return n;
            return e;
          })(r),
        u = [];
      rt(a) < rt(t);
  ...
  var ws = wt({ week: "short" }),
    Rs = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.allDaySplitter = new vs()),
          (t.headerElRef = Lr()),
          (t.rootElRef = Lr()),
          (t.scrollerElRef = Lr()),
                  ...
                  content: function (e) {
                    return Ar(
                      ...
                      Ar(
                        ...
                        null,
                        e.tableColGroupNode,
                        Ar("tbody", null, Ar(ks, { slatMetas: i }))
                      ),
                      Ar(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        Ar(xi, { unit: h ? "minute" : "day" }, function (e) {
        ...
        var o,
          i = (function (e) {
            ...
            for (t = 0; t < e.length; t++) {
              for (n = e[t], r = 0; r < o.length && Ps(n, o[r]).length; r++);
  ...
  var As = wt({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    Us = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Ar(
              ta,
              r({}, this.props, { defaultTimeFormat: As, extraClassNames: e })
            )
          );
        }),
        t
  ...
  ci.timeGridEventCondensedHeight = 30;
  var Ls = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
                ...
                r(
                  {
                    ...
                    isCondensed:
                      e.bottom - e.top < ci.timeGridEventCondensedHeight,
                  },
                  wn(e, l.todayRange, l.nowDate)
                )
              )
            );
          });
          ...
          if (i.slatCoords) {
            ...
            var a = e.map(function (e) {
              return Ar(
                ...
                "bg-event" === t
                  ? Ar(ua, r({ seg: e }, wn(e, i.todayRange, i.nowDate)))
                  : la(t)
              );
            });
            return Ar(Wr, null, a);
    ...
    Vs = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.splitFgEventSegs = ut(Ms)),
          (t.splitBgEventSegs = ut(Ms)),
          (t.splitBusinessHourSegs = ut(Ms)),
          (t.splitNowIndicatorSegs = ut(Ms)),
          (t.splitDateSelectionSegs = ut(Ms)),
          (t.splitEventDrag = ut(xs)),
          (t.splitEventResize = ut(xs)),
          (t.rootElRef = Lr()),
          (t.cellElRefs = new Wi()),
          t
        );
  ...
  var Bs = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return Ar(xi, { unit: a ? "minute" : "day" }, function (l, u) {
          return Ar(
            zs,
            r(
  ...
  var Gs = (function (e) {
    ...
    qs = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.buildTimeColsModel = ut(Ys)), (t.buildSlatMetas = ut(Cs)), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  var Js = wt({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
    $s = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = e.seg,
            r = t.options.eventTimeFormat || Js;
          return Ar(
            ea,
            {
              seg: n,
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    if (
                      (o.allDay
                        ...
                        ? e.isStart
                          ? (s = Cn(e, t, n, null, null, i.range.start, e.end))
                          : e.isEnd
                          ? (s = Cn(e, t, n, null, null, e.start, i.range.end))
                          : (a = !0)
                        : (s = Cn(e, t, n)),
                      a)
                    ) {
  ...
  var tl = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.computeDateVars = ut(rl)),
        (t.eventStoreToSegs = ut(t._eventStoreToSegs)),
    ...
    return (
      ...
      (t.prototype.renderSegList = function (e, t) {
        ...
        return Ar(xi, { unit: "day" }, function (e, n) {
          for (var s = [], l = 0; l < a.length; l++) {
            var u = a[l];
            if (u) {
              var c = t[l].toISOString();
              s.push(Ar(Xs, { key: c, dayDate: t[l], todayRange: n }));
              for (
                var d = 0, p = (u = yn(u, i.eventOrder));
                d < p.length;
                d++
              ) {
                var f = p[d];
  ...
  function rl(e) {
    for (
      var t = ke(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;
  ...
  (al.prototype.classes = {
    ...
    (al.prototype.baseIconClass = "fa"),
    (al.prototype.iconClasses = {
      close: "fa-times",
    ...
    (al.prototype.rtlIconClasses = {
      prev: "fa-chevron-right",
      next: "fa-chevron-left",
      prevYear: "fa-angle-double-right",
      nextYear: "fa-angle-double-left",
    }),
    (al.prototype.iconOverrideOption = "bootstrapFontAwesome"),
    (al.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome"),
    (al.prototype.iconOverridePrefix = "fa-");
  var sl = so({ themeClasses: { bootstrap: al } });
  var ll = so({
    eventSourceDefs: [
      {
        parseMeta: function (e) {
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = Se(e.start, -1).toISOString()),
                    (s = Se(e.end, 1).toISOString()));
                (i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
  ...
  return (
    Bo.push(Va, hs, Zs, il, sl, ll),
    (e.BASE_OPTION_DEFAULTS = Tt),
    (e.BASE_OPTION_REFINERS = Rt),
    (e.BaseComponent = qr),
    (e.BgEvent = ua),
    (e.BootstrapTheme = al),
    (e.Calendar = fa),
    ...
    (e.CalendarDataManager = Yo),
    (e.CalendarDataProvider = ri),
    (e.CalendarRoot = Ci),
    (e.Component = Or),
    (e.ContentHook = ho),
    (e.CustomContentRenderContext = fo),
    (e.DateComponent = ao),
    (e.DateEnv = Qn),
    ...
    (e.TableView = za),
    (e.Theme = Hr),
    (e.ThirdPartyDraggable = Wa),
    (e.TimeCols = zs),
    (e.TimeColsSlatsCoords = gs),
    (e.TimeColsView = Rs),
    (e.ViewApi = Wn),
    ...
    (e.addMs = De),
    (e.addWeeks = Ee),
    (e.allowContextMenu = ue),
    (e.allowSelection = se),
    (e.applyMutationToEventStore = An),
    (e.applyStyle = X),
    (e.applyStyleProp = K),
    ...
    (e.buildDayRanges = js),
    (e.buildDayTableModel = fs),
    (e.buildEventApis = Yn),
    (e.buildEventRangeKey = Tn),
    ...
    (e.buildSegCompareObj = En),
    (e.buildSegTimeText = Cn),
    (e.buildSlatMetas = Cs),
    (e.buildTimeColsModel = Ys),
    (e.collectFromHash = Ye),
    (e.combineEventUis = jt),
    (e.compareByFieldSpec = pe),
    (e.compareByFieldSpecs = de),
    (e.compareNumbers = ve),
    (e.compareObjs = Ge),
    (e.computeEdges = wr),
    ...
    (e.computeRect = Tr),
    (e.computeSegDraggable = Sn),
    (e.computeSegEndResizable = bn),
    (e.computeSegStartResizable = Dn),
    (e.computeShrinkWidth = Vi),
    (e.computeSmallestCellWidth = me),
    (e.computeVisibleDayRange = tn),
    (e.config = ci),
    (e.constrainPoint = cr),
    (e.createContext = Vr),
    (e.createDuration = $e),
    ...
    (e.createEventInstance = Ae),
    (e.createEventUi = Bt),
    (e.createFormatter = wt),
    (e.createPlugin = so),
    (e.createRef = Lr),
    (e.diffDates = rn),
    (e.diffDayAndTime = we),
    ...
    (e.elementMatches = q),
    (e.enableCursor = ie),
    (e.eventTupleToStore = At),
    (e.filterEventStoreDefs = Vt),
    (e.filterHash = We),
    ...
    (e.formatDayString = at),
    (e.formatIsoTimeString = st),
    (e.formatRange = function (e, t, n) {
      ...
      return i && a
        ? r.formatRange(i.marker, a.marker, o, {
            ...
            defaultSeparator: Tt.defaultRangeSeparator,
          })
        : "";
    }),
    (e.getAllowYScrolling = Fi),
    (e.getClippingParents = kr),
    (e.getDateMeta = gr),
    (e.getDayClassNames = mr),
    (e.getDefaultEventEnd = On),
    (e.getElSeg = vn),
    (e.getEventClassNames = Rn),
    (e.getIsRtlScrollbarOnLeft = Dr),
    (e.getRectCenter = dr),
    (e.getRelevantEvents = Ut),
    (e.getScrollGridClassNames = Zi),
    (e.getScrollbarWidths = br),
    (e.getSectionClassNames = Xi),
    (e.getSectionHasLiquidHeight = zi),
    (e.getSegMeta = wn),
    ...
    (e.identity = Ht),
    (e.interactionSettingsStore = li),
    (e.interactionSettingsToStore = si),
    (e.intersectRanges = sn),
    (e.intersectRects = ur),
    (e.isArraysEqual = W),
    (e.isColPropsEqual = ji),
    (e.isDateSpansEqual = xn),
    (e.isInt = ge),
    ...
    (e.memoizeObjArg = ct),
    (e.mergeEventStores = Wt),
    (e.multiplyDuration = tt),
    (e.padStart = he),
    (e.parseBusinessHours = sr),
    (e.parseClassNames = zt),
    (e.parseDragMeta = pi),
    (e.parseEventDef = Qt),
    (e.parseFieldSpecs = ce),
    (e.parseMarker = $n),
    (e.pointInsideRect = lr),
    (e.preventContextMenu = le),
    (e.preventDefault = J),
    (e.preventSelection = ae),
    (e.rangeContainsMarker = dn),
    (e.rangeContainsRange = cn),
    (e.rangesEqual = ln),
    (e.rangesIntersect = un),
    (e.refineEventDef = Jt),
    (e.refineProps = Nt),
    (e.removeElement = V),
    ...
    (e.triggerDateSelect = Nn),
    (e.unpromisify = Mr),
    (e.version = "<%= version %>"),
    (e.whenTransitionDone = te),
