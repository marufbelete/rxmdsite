...
(function (g, q, f) {
  function p(a, b) {
    ...
    this.translateZ =
      this.options.HWCompositing && d.hasPerspective ? " translateZ(0)" : "";
  ...
  function v(a, b) {
    ...
    this.options.interactive &&
      (this.options.disableTouch ||
        (d.addEvent(this.indicator, "touchstart", this),
        d.addEvent(g, "touchend", this)),
      this.options.disablePointer ||
        (d.addEvent(this.indicator, d.prefixPointerEvent("pointerdown"), this),
        d.addEvent(g, d.prefixPointerEvent("pointerup"), this)),
      this.options.disableMouse ||
        (d.addEvent(this.indicator, "mousedown", this),
  ...
  var t =
    ...
    d = (function () {
      ...
      b.prefixPointerEvent = function (a) {
        return g.MSPointerEvent
          ? "MSPointer" + a.charAt(7).toUpperCase() + a.substr(8)
          : a;
      };
      ...
      b.isBadAndroid = (function () {
        ...
        return /Android/.test(a) && !/Chrome\/\d/.test(a)
          ? (a = a.match(/Safari\/(\d+.\d)/)) &&
            "object" === typeof a &&
            2 <= a.length
            ? 535.19 > parseFloat(a[1])
            : !0
          : !1;
      })();
      b.extend((b.style = {}), {
  ...
  p.prototype = {
          ...
          (1 != d.eventType[a.type] &&
            0 !==
              (a.which
                ...
                : 2)) ||
          !this.enabled ||
          (this.initiated && d.eventType[a.type] !== this.initiated)
        )
      ) {
        !this.options.preventDefault ||
          d.isBadAndroid ||
          d.preventDefaultException(
            a.target,
      ...
      if (this.enabled && d.eventType[a.type] === this.initiated) {
        ...
        if (!(300 < k - this.endTime && 10 > b && 10 > h)) {
          this.directionLocked ||
            this.options.freeScroll ||
            (this.directionLocked =
              b > h + this.options.directionLockThreshold
                ? "h"
                : h >= b + this.options.directionLockThreshold
                ? "v"
                : "n");
            ...
            if (this._events.flick && 200 > c && 100 > h && 100 > g)
              ...
              this.options.snap &&
                ...
                (b =
                  ...
                  f.max(
                    f.max(
                      f.min(f.abs(e - l.x), 1e3),
                      f.min(f.abs(k - l.y), 1e3)
                    ),
                    300
                  )),
                (e = l.x),
    ...
    scrollTo: function (a, b, c, e) {
      ...
      !c || f
        ? (f &&
            (this._transitionTimingFunction(e.style), this._transitionTime(c)),
          this._translate(a, b))
        : this._animate(a, b, c, e.fn);
    },
    scrollToElement: function (a, b, c, e, k) {
      if ((a = a.nodeType ? a : this.scroller.querySelector(a))) {
        ...
        !0 === c &&
          (c = f.round(a.offsetWidth / 2 - this.wrapper.offsetWidth / 2));
        !0 === e &&
          (e = f.round(a.offsetHeight / 2 - this.wrapper.offsetHeight / 2));
        h.left -= c || 0;
        h.top -= e || 0;
        h.left =
          0 < h.left ? 0 : h.left < this.maxScrollX ? this.maxScrollX : h.left;
        h.top =
          0 < h.top ? 0 : h.top < this.maxScrollY ? this.maxScrollY : h.top;
        b =
          void 0 === b || null === b || "auto" === b
            ? f.max(f.abs(this.x - h.left), f.abs(this.y - h.top))
            : b;
    ...
    _translate: function (a, b) {
      this.options.useTransform
        ? (this.scrollerStyle[d.style.transform] =
    ...
    _initEvents: function (a) {
      ...
      d.hasPointer &&
        !this.options.disablePointer &&
        (a(this.wrapper, d.prefixPointerEvent("pointerdown"), this),
    ...
    getComputedPosition: function () {
      var a = g.getComputedStyle(this.scroller, null),
        b;
      this.options.useTransform
        ? ((a = a[d.style.transform].split(")")[0].split(", ")),
          (b = +(a[12] || a[4])),
          (a = +(a[13] || a[5])))
        : ((b = +a.left.replace(/[^-\d.]/g, "")),
          (a = +a.top.replace(/[^-\d.]/g, "")));
      return { x: b, y: a };
    },
        ...
        if ("deltaX" in a)
          1 === a.deltaMode
            ? ((b = -a.deltaX * this.options.mouseWheelSpeed),
              (a = -a.deltaY * this.options.mouseWheelSpeed))
    ...
    _initSnap: function () {
      ...
      this.on("refresh", function () {
        ...
        if (
          ...
          0 === this.options.snapThreshold % 1
            ? (this.snapThresholdY = this.snapThresholdX =
                this.options.snapThreshold)
            : ((this.snapThresholdX = f.round(
                this.pages[this.currentPage.pageX][this.currentPage.pageY]
                  .width * this.options.snapThreshold
              )),
              (this.snapThresholdY = f.round(
                this.pages[this.currentPage.pageX][this.currentPage.pageY]
      ...
      this.on("flick", function () {
        var a =
          ...
          f.max(
            f.max(
              f.min(f.abs(this.x - this.startX), 1e3),
              f.min(f.abs(this.y - this.startY), 1e3)
            ),
            300
          );
        this.goToPage(
    ...
    _nearestSnap: function (a, b) {
      ...
      var c = 0,
        ...
        d = 0;
      if (
        f.abs(a - this.absStartX) < this.snapThresholdX &&
        f.abs(b - this.absStartY) < this.snapThresholdY
      )
      ...
      d == this.currentPage.pageY &&
        ...
        0 > d
          ? (d = 0)
          : d >= this.pages[0].length && (d = this.pages[0].length - 1),
        (b = this.pages[0][d].y));
      ...
      c =
        void 0 === c
          ? this.options.snapSpeed ||
            f.max(
              f.max(
                f.min(f.abs(g - this.x), 1e3),
                f.min(f.abs(h - this.y), 1e3)
              ),
              300
            )
          : c;
    ...
    _key: function (a) {
      if (this.enabled) {
        ...
        this.keyAcceleration =
          200 > g - h ? f.min(this.keyAcceleration + 0.25, 50) : 0;
        switch (a.keyCode) {
          case this.options.keyBindings.pageUp:
            this.hasHorizontalScroll && !this.hasVerticalScroll
              ? (c += b ? 1 : this.wrapperWidth)
              : (e += b ? 1 : this.wrapperHeight);
            break;
        ...
        b
          ? this.goToPage(c, e)
          : (0 < c
              ? (this.keyAcceleration = c = 0)
              : c < this.maxScrollX &&
                ((c = this.maxScrollX), (this.keyAcceleration = 0)),
            0 < e
              ? (this.keyAcceleration = e = 0)
              : e < this.maxScrollY &&
  ...
  v.prototype = {
    ...
    destroy: function () {
      ...
      this.options.interactive &&
        ...
        d.removeEvent(
          this.indicator,
          d.prefixPointerEvent("pointerdown"),
          this
        ),
    ...
    _start: function (a) {
      ...
      this.options.disablePointer ||
        d.addEvent(g, d.prefixPointerEvent("pointermove"), this);
      ...
      if (this.initiated) {
        ...
        if (this.scroller.options.snap) {
          ...
          var b =
            ...
            f.max(
              f.max(
                f.min(f.abs(this.scroller.x - a.x), 1e3),
                f.min(f.abs(this.scroller.y - a.y), 1e3)
              ),
              300
            );
    ...
    updatePosition: function () {
      var a =
          (this.options.listenX &&
            f.round(this.sizeRatioX * this.scroller.x)) ||
          0,
        b =
          (this.options.listenY &&
            f.round(this.sizeRatioY * this.scroller.y)) ||
          0;
      this.options.ignoreBoundaries ||
        (a < this.minBoundaryX
          ? ("scale" == this.options.shrink &&
              ((this.width = f.max(this.indicatorWidth + a, 8)),
        ...
        b < this.minBoundaryY
          ? ("scale" == this.options.shrink &&
              ((this.height = f.max(this.indicatorHeight + 3 * b, 8)),
      ...
      this.scroller.options.useTransform
        ? (this.indicatorStyle[d.style.transform] =
            "translate(" + a + "px," + b + "px)" + this.scroller.translateZ)
